...
export const { actions, reducer } = createSymbiote<IFormsState, IFormStateReducerActions>({
    ...
    wasSendCustomer: (state: IFormsState) => ({ ...state, wasSendCustomer: true, errSendCustomer: false }),
    wasSendJoin: (state: IFormsState) => ({ ...state, wasSendJoin: true, errSendJoin: false }),
    errSendCustomer: (state: IFormsState) => ({ ...state, errSendCustomer: true }),
    errSendJoin: (state: IFormsState) => ({ ...state, errSendJoin: true }),
    isSendingCustomer: (state: IFormsState) => ({ ...state, isSendingCustomer: true }),
